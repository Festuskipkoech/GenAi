...
def user_input(user_question):
    ...
    docs=new_db.similarity(user_question)
...
def main():
    ...
    user_question=st.text_input("Ask smart pdf")

    if user_question:
        user_input(user_question)
    with st.sidebar:
        st.title("Menu:")
        pdf_docs=st.file_uploader("Upload your PDF Files and Click on the Submit and Process buttons")
